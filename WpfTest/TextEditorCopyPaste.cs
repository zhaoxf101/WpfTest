...
namespace WpfTest
{
    ...
    internal static class TextEditorCopyPaste
    {
        ...
        /// </SecurityNote>
        [SecurityCritical]
        internal static DataObject _CreateDataObject(RichTextBox This, bool isDragDrop)
        {
            ...
            if (textString != String.Empty)
            {
                ...
                if (ConfirmDataFormatSetting(This, dataObject, DataFormats.Text))
                {
                ...
                // ConfirmDataFormatSetting rasies a public event - could throw recoverable exception.
                if (ConfirmDataFormatSetting(This, dataObject, DataFormats.UnicodeText))
                {
            ...
            if (SecurityHelper.CheckUnmanagedCodePermission())
            {
                ...
                if (xamlTextWithImages.Length > 0)
                {
                    ...
                    if (wpfContainerMemory != null && ConfirmDataFormatSetting(This, dataObject, DataFormats.XamlPackage))
                    {
                        dataObject.SetData(DataFormats.XamlPackage, wpfContainerMemory);
                    }

                    // ConfirmDataFormatSetting raises a public event - could throw recoverable exception.
                    if (ConfirmDataFormatSetting(This, dataObject, DataFormats.Rtf))
                    {
