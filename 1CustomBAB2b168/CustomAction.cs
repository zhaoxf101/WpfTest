...
namespace CustomBA
{
    ...
    {
        readonly static string BackupFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "B2b168_UpdateService");
        ...
        internal static void Backup(string installFolder)
        {
            ...
            if (autoStart)
            {
                try
                {
                    ...
                    bool success = Util.RegisterAutoStart(updateServiceFileName, "B2b168_UpdateService", true);
        ...
        internal static void CleanUp(string installFolder)
        {
            try
            {
                var result = Util.RegisterAutoStart("", "B2b168_MarketingPlatform.Client", false);
